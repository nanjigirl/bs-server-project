<template>
  <el-row class="wrap">
    <el-col :span="24" class="toolbar" style="padding-bottom:0px;">
      ...
      <!--列表-->
      <el-table :data="tableDatas" highlight-current-row v-loading.body="isLoading">
        <el-table-column prop="id" label="序号" width="160"></el-table-column>
        <el-table-column prop="date" label="日期" width="240"></el-table-column>
        <el-table-column prop="name" label="站点名称" width="350"></el-table-column>
        <el-table-column prop="actual" label="真实值" sortable></el-table-column>
        <el-table-column prop="predict" label="预测值" sortable></el-table-column>
        <el-table-column prop="diff" label="误差"></el-table-column>
        <el-table-column prop="isSave" label="是否保留" width="150"></el-table-column>
      </el-table>
    </el-col>
  </el-row>
</template>
